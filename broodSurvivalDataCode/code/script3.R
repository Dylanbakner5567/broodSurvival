...
#call jags from r
m3 <- jags(jags.data3, inits, parameters, "jagsScript2.txt", n.chains = nc, n.thin = nt, n.iter = ni, n.burnin = nb, parallel = TRUE)
print(m3, digits = 3)

#save r environment 
save.image("C:/Users/dylan.bakner/Documents/manuscripts/turkeyBroodSurvival/submissionDocs/output/enviroments/script3Enviroment.RData")
